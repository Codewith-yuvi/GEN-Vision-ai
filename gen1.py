...
# Lottie animation
st_lottie(lottie_coding, speed=0.1, loop=True, height=250, width=250, key="coding_lottie")
...
if submit:
    ...
    with placeholder.container():
        if lottie_spinner:
            st_lottie(lottie_spinner, speed=0.1, loop=True, height=200, width=200, key="loading_spinner")
